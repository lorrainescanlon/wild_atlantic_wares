...
class StripeWH_Handler:
    ...
    def handle_payment_intent_succeeded(self, event):
        ...
        # Check whether order exists in database
        order_exists = False
        attempt = 1
        while attempt <=5:
            try:
                order = Order.objects.get(
                    ...
                    address1__iexact=shipping_details.line1,
                    address2__iexact=shipping_details.line2,
        ...
        if order_exists:
            ...
            try:
                order = Order.objects.create(
                    ...
                    address1=shipping_details.line1,
                    address2=shipping_details.line2,
