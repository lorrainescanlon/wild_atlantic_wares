...
class Order(models.Model):
    ...
    stripe_pid = models.CharField(max_length=250, null=False, blank=False,
                                  default='')
    ...
    def update_total(self):
        """
        Update the grand total and delivery costs each time an item is added
        """
...
class OrderLineItem(models.Model):
    ...
    def save(self, *args, **kwargs):
        """
        Override the original save method to calcualte the lineitem total
        and update the oder subtotal
        """
